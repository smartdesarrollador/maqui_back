...
class AccesorioSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen1.jpg',
            'tipo_accesorio_id' => 1,
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen2.jpg',
            'tipo_accesorio_id' => 1,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen3.jpg',
            'tipo_accesorio_id' => 2,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen4.jpg',
            'tipo_accesorio_id' => 2,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen5.jpg',
            'tipo_accesorio_id' => 3,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen6.jpg',
            'tipo_accesorio_id' => 3,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen7.jpg',
            'tipo_accesorio_id' => 4,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen8.jpg',
            'tipo_accesorio_id' => 4,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen9.jpg',
            'tipo_accesorio_id' => 5,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
        ...
        DB::table('accesorios')->insert([
            ...
            'imagen' => 'assets/imagen/accesorios/imagen10.jpg',
            'tipo_accesorio_id' => 5,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
        ...
        DB::table('accesorios')->insert([
            ...
            'precio' => 29.99,
            'stock' => 20,
            'descripcion' => 'Cargador de batería para celulares',
            'imagen' => 'assets/imagen/accesorios/imagen11.jpg',
            'tipo_accesorio_id' => 1,
            'created_at' => $horaActual,
            'updated_at' => $horaActual,
        ]);
